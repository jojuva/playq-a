define(['jquery', 'underscore', 'backbone.extend', 'moment', 'views/headerView', 'views/dialogs/alertPopup', 'text!templates/jqmPage.html', 'text!templates/login.html', 'jqm'],
//	function($, _, Backbone, Header, LoginUtils, UserLogin, AlertPopup, jqmPageTpl, loginTpl) {
	function($, _, Backbone, moment, Header, AlertPopup, jqmPageTpl, loginTpl) {
