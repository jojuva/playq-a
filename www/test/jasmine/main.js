require.config({
  ...
  paths: {
    ...
    'spec/helper': '../test/jasmine/helper',
    'spec/index': '../test/jasmine/index',
    'modelsTest': '../test/jasmine/models/',
    'viewsTest': '../test/jasmine/views/'
...
require(['underscore', 'jquery', 'jasmine-html', 'jasmine-jquery', 'backbone.extend', 'i18n', 'parse', 'app-config'], 
		function(_, $, jasmine, Backbone, i18n){
	  ...
	  specs.push('modelsTest/answerTest');
